  ...
  return (
    <>
      <div className="desktop-sidebar" style={{
        ...
        <div>
          <div style={{ fontSize: '10px', color: '#374151', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '8px', fontWeight: 700 }}>Navigate</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            {NAV_ITEMS.map(({ page, emoji, label }) => {
              const isActive = currentPage === page;
              const fullLabel = label === 'Heatmap' ? 'Topic Heatmap' : label === 'Ancestry' ? 'Find Ancestry' : 'Concepts & Quiz';
              return (
